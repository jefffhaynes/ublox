...
namespace ublox.Test
{
    public class MessageTests : TestBase
    {
        ...
        public void NavPvt()
        {
            var dateTimeTicks = 636298095393575746;

            var navPvt = new NavPvt
            {
                GpsTimeOfWeek = new GpsTimeOfWeek(TimeSpan.FromDays(2)),
                UbloxDateTime = new UbloxDateTime(new DateTime(dateTimeTicks)),
            ...
            Serialize(navPvt,
                new byte[]
                {
                    0xb5, 0x62, 0x01, 0x07, 0x54, 0x00, 0x00, 0xb8, 0x4c, 0x0a, 0xe1, 0x07, 0x05, 0x08, 0x03, 0x05,
                    ...
                    0x12, 0x00, 0x35, 0x00, 0x00, 0xd8, 0x5a, 0x62, 0x01, 0x00, 0xf9, 0xae
                });
        }
    }
}
